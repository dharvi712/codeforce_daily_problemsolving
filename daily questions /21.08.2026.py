...
Ithea writes three non-negative integers 𝑎, 𝑏, and 𝑐 on the blackboard.
...
∗The range of a non-empty finite collection of numbers is defined as its maximum value minus its minimum value. In particular, the range of three numbers 𝑥, 𝑦, and 𝑧 is max(𝑥,𝑦,𝑧)−min(𝑥,𝑦,𝑧).
Input
...
The only line of each test case contains three integers 𝑎, 𝑏, and 𝑐 (0≤𝑎,𝑏,𝑐≤109) — the integers initially written on the blackboard.
